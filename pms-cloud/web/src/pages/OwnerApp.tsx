...
const NAV_ITEMS: { id: Page; label: string; icon: string; mobile?: boolean }[] = [
  ...
  { id: 'stock', label: 'المخزون', icon: 'chart-bar', mobile: false },
  { id: 'balances', label: 'الأرصدة', icon: 'credit-card', mobile: false },
  { id: 'accounts', label: 'الحسابات', icon: 'banknotes', mobile: false },
  { id: 'supplier_accounts', label: 'الموردين', icon: 'user-group', mobile: false },
  { id: 'activity', label: 'النشاط', icon: 'clock', mobile: true },
  { id: 'sync', label: 'المزامنة', icon: 'sync', mobile: false },
  { id: 'backups', label: 'النسخ الاحتياطي', icon: 'database', mobile: false },
